...
export function renderEmergency() {
  ...
  function praxisCard() {
    return el("div", { class: "card cardPad" }, [
      ...
      el("p", { class: "p" }, ["Choose one. Then stop."]),
      el("div", { class: "btnRow" }, [
      ...
      el("p", { class: "small", style: "margin-top:10px" }, ["If risk spikes again, return here and use 911/988."]),
  ...
  function closureCard() {
    // Emergency closure state: REST (quiet release, no push)
    return el("div", { class: "card cardPad" }, [
      sectionLabel("Rest"),
  ...
  wrap.appendChild(immediateCard());
  wrap.appendChild(stabilizeCard());
  wrap.appendChild(praxisCard());
  wrap.appendChild(closureCard());
